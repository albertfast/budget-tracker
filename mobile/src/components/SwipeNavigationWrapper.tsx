        ...
        >
          ...
          >
            ...
            <View style={styles.container}>
              {/* Top Tab Selection Indicator */}
              {showIndicator && (
                <View style={[styles.topTabIndicator, { backgroundColor: getPageBackgroundColor(currentTab) }]}>
                  <View style={styles.tabIndicator}>
                    {tabs.map((tab, index) => (
                      <Pressable 
                        ...
                        style={[
                          styles.tabDot,
                          index === currentTabIndex && styles.tabDotActive
                        ]}
                        onPress={() => handleTabNavigation(index)}
                        hitSlop={{ top: 30, bottom: 30, left: 30, right: 30 }} // Large hit area to compensate for small visual size
                      />
                    ))}
                  </View>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    flexGrow: 1,
    paddingTop: 260, // Reduced scroll padding by 20px: 280 - 20 = 260px for better content separation
